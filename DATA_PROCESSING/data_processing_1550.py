...
spectrum_data = pd.read_csv('data/LED_spectrum_data/1550_spectrum.csv')
...
# EXPERIMENTAL DATA FOR 1550 LED 3
air_data = pd.read_csv('data/air_data_1550_counterclockwise_2024-02-18_12-02-47.csv')
plastic_data = pd.read_csv('data/plastic_data_1550_counterclockwise_2024-02-18_12-08-39.csv')
water_data = pd.read_csv('data/water_data_1550_counterclockwise_2024-02-18_12-15-42.csv')
...
ax1.plot(wavelengths_model, intensity_model, label='1550 LED spectrum data')
